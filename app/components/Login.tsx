				...
				<div className="mt-14">
					...
					<form className="mt-10 space-y-4" onSubmit={handleSubmit}>
						...
						<div className="space-y-1">
							...
							/>
							{errorMessage && (
								<p className="mt-4 text-xs text-[#FF6B6B] text-center">{errorMessage}</p>
							)}
						</div>
						{/* 登録ボタン */}
						<button
