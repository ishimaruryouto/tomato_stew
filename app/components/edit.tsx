...
export default function edit() {
    return (
        <>
            ...
            {/* 線（灰色） */}
            <div className="h-0.5 bg-[#222]/20 mt-6 mb-2"></div>
            <div className="flex w-full ">
                <p className="w-[30%]">名前</p>
                <p className="w-[70%]">りょうと</p>
            </div>
            {/* 線（灰色） */}
            <div className="h-0.5 bg-[#222]/20 my-2"></div>
            <div className="flex ">
                <p className="w-[30%]">ID</p>
                <p className="w-[70%]">@tomato</p>
            </div>
            {/* 線（灰色） */}
            <div className="h-0.5 bg-[#222]/20 mt-2"></div>

            {/* 線（黒色） */}
            <div className=" h-0.5 bg-black mt-7.5 mb-2"></div>
            ...
            <Image src="/img/black_cat_all.png" alt="黒猫の全身のイラスト" width={150} height={170} className="block mx-auto mt-14" />

            <button type="button" className="w-50 h-12 rounded-full bg-[#FFCC01] drop-shadow-[0_2px_4px_rgba(34,34,34,0.30)] mx-auto mt-12.5 block">決定する</button>
