    ...
    return (
        <>
            ...
            <div className="relative w-full h-auto">
                <div className="absolute top-[-40px] left-10 bg-[url('/img/cat_tail.png')] bg-no-repeat bg-contain w-[75px] h-[160px]"></div>
                <div className="absolute top-[-20px] right-13 bg-[url('/img/cat_hands.png')] bg-no-repeat bg-contain w-[115px] h-[115px]"></div>
            </div>
            <div className="pt-6">
                ...
                <div className="w-38 h-38 rounded-full mx-auto">
                    <Image src="/img/shisa.png" alt="シーサーのイラスト" width={152} height={152} />
                </div>
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col items-center mt-6">
                        ...
                        <Image src="/img/photo.png" alt="フォトのイラスト" width={40} height={40} className="mt-2" />
                    </div>
                </div>
                <div className="w-full h-0.5 bg-black mt-6 px-0"></div>
                <div className="relative mt-4 drop-shadow-[0_2px_4px_rgba(34,34,34,0.30)]">
