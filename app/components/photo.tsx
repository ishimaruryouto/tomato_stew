		...
		<>
			...
			<div className={`w-screen h-screen ${theme.pageBg}`}>
				...
				<div className="pt-6">
					...
					<div
						className={`w-38 h-38 rounded-full mx-auto flex items-center justify-center ${theme.labelBorder}`}
					>
					...
					<div className="relative mt-9.5 drop-shadow-[0_2px_4px_rgba(34,34,34,0.30)]">
						...
						<div className="absolute top-0 left-6 w-78.75 h-103.75 bg-[#F9F9F9] z-20 ml-2 relative">
							<div
								ref={albumRef}
